window.HUNT = {
  ...
  stops: [
    { n: 1, pin: "hearth", title: "The first mark", riddle: "On this map, find where mornings begin \u2014 fire, cups, the first light.", clue: "You marked the hearth. The next paper mark is in the kitchen, near the cups.", hint: "Kitchen. Coffee.", image: "media/love.jpg" },
