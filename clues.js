  ...
  stops: [
    {
      ...
      quiz: [
        {
          q: "I built you things for our anniversary. One of them needed plexiglass. Do you remember what it was?",
          a: ["hologram", "a hologram", "the hologram", "holograms", "holographic"],
          image: "media/holo.jpg"
        }
      ],
    ...
    },
    {
      ...
      riddle: "Find the cliff on the map \u2014 water falling, the world dropping away.",
      clue: "You marked the high place. Hunt the spot in the house where you sit together.",
      hint: "Couch, chairs, the watch-something-together place.",
      image: "media/falls.jpg"
    },
    {
      n: 3,
      pin: "lantern",
    ...
    },
    {
      ...
      pin: "den",
      title: "Safe harbor",
      riddle: "Find the harbor \u2014 soft, small, someone asleep against you.",
      clue: "You marked safe harbor. Last hide before the X: where she sleeps with the small one.",
      hint: "Couch or bed. By the dog.",
      image: "media/dog.jpg"
    },
    {
      n: 5,
      ...
      riddle: "Put your finger on the X.",
      final: true,
      ...
      images: ["media/love.jpg","media/falls.jpg","media/selfie.jpg","media/dog.jpg","media/family.jpg","media/bath.jpg"],
      video: "media/race.mp4"
    }
  ]
};
